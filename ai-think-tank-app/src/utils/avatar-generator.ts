...
const mapDemographics = (persona: Persona): Partial<DiceBearOptions> => {
  ...
  if (persona.demographics?.ethnicity) {
    ...
    } else if (ethnicity.includes('middle eastern') || ethnicity.includes('arab')) {
  ...
  if (persona.personality?.traits?.includes('intellectual') ||
  ...
  if (persona.demographics?.gender) {
    ...
    if (gender === 'female' || gender === 'woman') {
      ...
      options.hairColor = options.hairColor || ['2c1b18', '4a3c3b', '6b5d5c', '8c7e7d', 'b89778']
    } else if (gender === 'male' || gender === 'man') {
      options.hair = ['short01', 'short02', 'short03', 'short04', 'short05', 'curly01', 'curly02']
      options.hairColor = options.hairColor || ['2c1b18', '4a3c3b', '1a1a1a', '3d3d3d']
    }
  }
